...
<head>
	...
	var sendChat = function (message, callback) {
		$.getJSON('<?php echo site_url("api/send_message");?>?message=' + message + '&guid=' + getCookie('user_guid') , function (data){
			 callback();
		});
	...
	var append_chat_data = function (chat_data) {
		chat_data.forEach(function (data) {
			...
			if(is_me){
				...
				html += '			<strong class="pull-right primary-font" style="color:#FA6F57">' + data.username + '</strong>';
				html += '		</div>';
				...
				html += '	<div class="chat-body clearfix">';
				html += '		<div class="header">';
				html += '			<strong class="primary-font" style="color:#55C1E7">' + data.username + '</strong>';
	...
	var update_chats = function () {
		...
		$.getJSON('<?php echo site_url("api/get_messages"); ?>?timestamp=' + request_timestamp, function (data){
			console.log(data);
...
<div class="container">
    <div class="row">
		<div class="panel panel-primary"   >
			<div class="panel-heading" style="background-color:#55C1E7">
				...
				<div class="clearfix">
					<div class="col-md-3">
						<div class="input-group">
							<span class="input-group-addon" style="color:#55C1E9"  >
								<i class="glyphicon glyphicon-user" style="color:#55C1E7"  ></i>
								Username:
							</span>
							<input disabled id="username"  value = '<?php echo $username;  ?>' type="text" class="form-control input-large" />
