...
var sendChat = function (message, callback) {
    $.getJSON('http://localhost/projekti/index.php/api/send_message?message=' + message + '&nickname=' + $('#nickname').val() + '&guid=' + getCookie('user_guid'), function (data){ callback();
    });
}
...
var update_chats = function () {
    ...
    $.getJSON('http://localhost/projekti/index.php/api/get_messages?timestamp=' + request_timestamp, function (data){
...
setInterval(function (){ update_chats(); }, 1500);
